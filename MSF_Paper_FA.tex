...
\begin{figure}[ht!]
	...
	\begin{subfigure}{.6\textwidth}
		\centering
		\includegraphics[width=6.5cm]{Tgfb1.png}
		\caption{Input}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=6.5cm]{TGFBstep1.png}
		\caption{Step 1}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=6.5cm]{TGFBstep2.png}
		\caption{Step 2}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=6.5cm]{TGFBstep3.png}
		\caption{Step 3}
	\end{subfigure}
	\caption{Overview of \texttt{MSF} process steps exemplified on a simplified toy
          example. (a) Input:
          ...
          with the addition of 3 genes Z,W,P.\label{fig:algorithm}}
			\end{minipage}
}
...
\begin{figure*}
	...
	\caption{Shows the three modulated sub-graphs identified by
          MSF at 6h~p.i., where nodes are genes and edges are the
