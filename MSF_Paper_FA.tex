...
\begin{figure*}[p]
	...
	\fbox{
		\begin{minipage}{17 cm}
			...
			\caption{The percentage of DEG analysis genes
...
\begin{figure*}[p]
	...
	\caption{The heatmap shows Reactome pathway enrichment for MSF identifed sub-graphs for the three time-points and the Reactome pathway enrichment for subset of DEG with adjusted p-value cut off of < 0.1. Green color shows the pathway being enriched and red color shows pathway not found as enriched.}
