	...
	\begin{figure*}[p]
		...
		\fbox{
			\begin{minipage}{13 cm}
				...
				\caption{\FA{Recall rates for genes in
                                  }\sout{Shows the percentage of}
                                  \texttt{MSF} identified sub-graph
                                  \sout{genes recall rates} for the
                                  three different time points of EBOV
                                  infection data for 100
                                  simulation\FA{s} where Poisson
		...
		\fbox{
			\begin{minipage}{15 cm}
				...
				\caption{The Upset plot shows the
                                  ...
                                  \sout{the} \FA{XXX} different
                                  toll-like receptor cascades are
                                  \sout{shown to be} in the \FA{set
                                    of}\sout{bar with} 164 shared
