...
\newcommand{\ILH}[1]{\begingroup\color{green}#1\endgroup}
		...
		\fbox{
			\begin{minipage}{17 cm}
				...
				\caption{Graphical representation of the \texttt{MSF}
					heuristic approach to detect modulated sub-graphs
	...
	\begin{figure*}
		...
		\fbox{
			\begin{minipage}{18 cm}
				...
				\caption{Visualization of the three modulated
	...
	\begin{figure*}
		...
		\fbox{
			\begin{minipage}{12 cm}
				...
				\caption{The Venn diagram shows the common genes identified as modulated from \texttt{MSF} identified sub-graphs and jActiveModules identified module.}
