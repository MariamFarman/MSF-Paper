...
\begin{figure*}[p]
	...
	\caption{The Upset plot shows the number of shared pathways between different time-point and cut offs. All the different toll-like receptor signaling pathways identified from \texttt{MSF} identified genes are marked. }
